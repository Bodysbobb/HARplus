...
#> 
#> Output file: /tmp/RtmpLK60cu/output_target.har
...
#>   REG: 3 prioritized values, remaining A-Z
#> 
#> Output file: /tmp/RtmpLK60cu/output_target_baseline.har
#> File size: 935 bytes
#> 
#> 
#> Generated new baseline file: /tmp/RtmpLK60cu/output_target_baseline.har
```
