...
export_data(data_multiple, file.path(tempdir(), "output_directory"), 
           ...
           create_subfolder = TRUE,
           multi_sheet_xlsx = TRUE)
#> Exported 2 file(s) to csv format in /tmp/RtmpLXo9TF/output_directory/csv
#> Exported multi-sheet Excel file 'output_directory.xlsx' to /tmp/RtmpLXo9TF/output_directory/xlsx
#> Exported 2 file(s) to stata format in /tmp/RtmpLXo9TF/output_directory/stata
#> Exported 2 file(s) to txt format in /tmp/RtmpLXo9TF/output_directory/txt
#> Exported 2 file(s) to rds format in /tmp/RtmpLXo9TF/output_directory/rds
# }
```
